...
public class DiscoveryActivity  extends ListActivity
{
	...
	private Runnable _discoveryWorkder = new Runnable() {
		public void run() {
			...
			for (;;) {
				if (_discoveryFinished) { Log.d("EF-BTBee", ">>Finished"); break; }
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SamplesUtils.indeterminate(DiscoveryActivity.this, _handler, "Scanning...", _discoveryWorkder,
				new OnDismissListener() {
			public void onDismiss(DialogInterface dialog) {
				for (; _bluetooth.isDiscovering();) { _bluetooth.cancelDiscovery(); }
				_discoveryFinished = true;
			}
		}, true);
	}
	...
	protected void showDevices() {
		...
		_handler.post(new Runnable() { public void run() { setListAdapter(adapter); } }); }
