...
public class ControlActivity extends Activity { //TODO might have to implement runnable, add in transfer part
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try 
        {
        	mUsbManager.requestPermission(mDevice, mPermissionIntent);        //TODO mDevice is NULL
        }
    ...
    class ControlThread extends Thread {
        ...
        public void run() { //check the run in the other program
            ...
            //request.initialize(mConnection, mEndpointIntr); TODO
        	Canvas c;
            while (_run) {
                c = null;
                try {
    ...
    //TODO figure out how to use this function, check onResume
